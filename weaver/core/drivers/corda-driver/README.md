...
* Copy `.env.docker.template` to `.env`
    ...
    - `DOCKER_TAG`: Refer here for the image tags available: [cacti-weaver-corda-driver](https://github.com/hyperledger/cacti/pkgs/container/cacti-weaver-corda-driver)
